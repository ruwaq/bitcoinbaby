...
export interface CharmsProverClientOptions {
  /** Prover base URL (default: https://v15.charms.dev) */
  proverUrl?: string;
 ...
 *
 * The Charms hosted prover is available at v15.charms.dev (latest).
 * This is the same prover used by BRO token (bro.charms.dev).
 *
 * Options:
 *
 * 1. HOSTED PROVER (recommended for production):
 *    - URL: https://v15.charms.dev/spells/prove
 ...
 * - Hosted prover (v15.charms.dev): /spells/prove
